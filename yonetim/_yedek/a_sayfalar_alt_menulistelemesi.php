 ...
 <!--MENÜLER CARDI BAŞ  -->
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">
<?php  if ($k==2){echo "Blog Listesi";}  elseif($k==100) {echo "Video Listesi";} elseif($k==20) {echo "Yazar Listesi";}  elseif($k==2000) {echo "Otel Oda Listesi";}   else {echo "Üst Menü Öğeleri"; }  ?>
...
<a href="a_sayfalar.php?k=<?php echo $k; ?>&action=edit&id=<?php echo $sayfaid; ?>&top1id=<?php echo $sayfaid; ?>" class="menulerli"><b><?php echo $sayfaadi; ?></b></a>
...
<a href="a_sayfalar.php?k=<?php echo $k; ?>&action=edit&id=<?php echo $sayfaid; ?>&top1id=<?php echo $sayfaid; ?>" class="btn btn-tool btn-link menukucuk"><i class="fas fa-pen"></i></a>
...
<a href="a_sayfalar.php?k=<?php echo $k; ?>&action=edit&id=<?php echo $sayfa_altid; ?>&top1id=<?php echo $sayfaid; ?>" class="btn btn-tool btn-link menukucuk"><i class="fas fa-pen"></i></a>
...
<a href="a_sayfalar.php?k=<?php echo $k; ?>&action=edit&id=<?php echo $sayfa_altid2; ?>&top1id=<?php echo $sayfaid; ?>" class="btn btn-tool btn-link menukucuk"><i class="fas fa-pen"></i></a>
