...
if(isset($_POST['slideyukle'])) {
      ...
      if(isset($_FILES["fileToUpload"]["name"])) {
                 ...
                 if (file_exists($yuklenendosya)) {
                  $toaster['error'] =  "Aynı isimde bir dosya mevcut, farklı bir isim verin."; 

                 }
                  else { //file_exists($yuklenendosya) 
                       ...
                       // ÇIKTILARI 
                        ...
                        if(true) {
                            ...
                            if ($mysqli->query($slidekayitsql ) === TRUE) {
                                 ...
                                 $toaster['error'] =  "Yükleme Hatası Oluştu=". $uploadMesaj; 
                      }   
...
////////////////////////////// HATA MESAJLARINI GÖNDER//////////////////////////////////////
          ...
          if(isset($uploaddurum)) {
                if($uploaddurum == "ok") {
                   ...
                   $git=BASE_ADMIN."a_slider.php?toast=info&toastmessage=".$uploadMesaj;
                   header("Location:".$git."");
...
?>
 ...
 <div class="row">
    ...
    <a href="<?php echo $target_dir. $slidergosterrow['adi']; ?>" data-toggle="lightbox" data-title="<?php echo $slidergosterrow['adi']; ?>"><img src="/upload/slider/<?php echo $slidergosterrow['adi'] ; ?>" style="width:100%; float:left;"> </a>
